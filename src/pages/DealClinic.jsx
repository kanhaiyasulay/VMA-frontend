...
export default function DealClinic() {
  ...
  const endConversation = () => {
    ...
    const latestSessionReport = {
      strength: "Strong negotiation strategy",
      weakness: "Closing could be faster",
      rating: 8,
      language: language,
      systemPrompt: systemPrompt
    };

    navigate("/deal-session-report", {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen px-6">
      ...
      <div className="mb-8 w-80">
        ...
        <textarea
          placeholder="Example: Act like an expert sales coach helping close deals..."
          value={systemPrompt}
